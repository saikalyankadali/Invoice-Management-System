    ...
    <div class="rcontent">
        ...
        <?php 
			if(isset($_GET['success'])){
				$result=mysql_query("INSERT INTO product VALUES(NULL,{$_POST['cprice']},{$_POST['supplier']},'{$_POST['product_name']}',{$_POST['quantity']},{$_POST['discount']},'{$_POST['product_type']}',{$_POST['mprice']})");
				...
				while($row = mysql_fetch_array($supplier_set))
					echo "<option value='{$row['sid']}'>{$row['sname']}</option>";
						...
						<tr><td style='padding:5px'>Discount: </td><td><input name='discount' type='text' /></td></tr>
