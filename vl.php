				...
				<div id="body">
					...
					<div class="container">
					  ...
					  <input class="form-control" id="myInput" type="text" placeholder="Search..">
													...
													<?php	$plist = mysql_query("select product_id, product_name, supplier_id, market_price, cost_price, discount from product");
...
?><a href = "addsupplier.php">Add</a><?php			
		}//end supplier
		//customer
	...
	elseif(!strcmp(strtolower($_GET['list']),"promo")){
		...
		//buy
		elseif(!strcmp(strtolower($_GET['list']),"buy")){
			echo"<h1><span>List of ".ucfirst($_GET['list'])."</span></h1>";
			echo"<div id='contentbo'><div id='data'><table id='itemList' ><tr><th>Purchase ID</th><th>Purchase Date</th><th>PID's</th><th>Total Amount</th><th>CID</th><th>First Name</th><th>Last Name</th><th>Options</th></tr>";
			$blist = mysql_query("select purchase_id, purchase_date, pids, total_amount, cid, first_name, last_name from buy");
			while($row = mysql_fetch_array($blist)){
				echo"<tr><td>{$row['purchase_id']}</td>
										...
										<td>{$row['last_name']}</td>
										<td><a href='editlist.php?name=dept&id={$row['purchase_id']}'>Edit</a></td>";
